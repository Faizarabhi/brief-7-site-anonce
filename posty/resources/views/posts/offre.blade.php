...
<div class="my-4  ml-48 ">
    <div  id="addpost" class=" bg-white p-6  rounded-lg hidden">
        @auth
        <form action="{{ route('posts/offre')}}" method="post"  class="mb-4" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
            <div class="mb-3 pt-0">
    ...
    <div class="flex  items-center  mr-40">
        ...
        <button type="button" class="max-w-xs min-w-fit text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Article demande</button>
        <button type="button" class="max-w-xs min-w-fit text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Article demande</button>
